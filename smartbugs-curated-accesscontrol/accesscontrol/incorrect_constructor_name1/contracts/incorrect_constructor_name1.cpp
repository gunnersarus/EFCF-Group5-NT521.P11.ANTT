...
#include "eEVM/evm2cpp/contracts/incorrect_constructor_name1.h"
...
0x80, /* [54'0x36] DUP1 */
0x63, /* [55'0x37] PUSH4 */
0x2e,0x40,0x71,0xd4,/* constant data */
0x14, /* [60'0x3c] EQ */
0x61, /* [61'0x3d] PUSH2 */
...
0x20, /* [419'0x1a3] SHA3 */
0xb8, /* [420'0x1a4] INVALID' byte */
0xbd, /* [421'0x1a5] INVALID' byte */
0xab, /* [422'0x1a6] INVALID' byte */
0x4a, /* [423'0x1a7] INVALID' byte */
0xb9, /* [424'0x1a8] INVALID' byte */
0x6b, /* [425'0x1a9] PUSH12 */
0x40,0x11,0x16,0xc2,0x5c,0xe3,0xba,0x48,0xe7,0x7d,0x7f,0x87,/* constant data */
0xa2, /* [438'0x1b6] LOG2 */
0x5f, /* [439'0x1b7] INVALID' byte */
0xf2, /* [440'0x1b8] CALLCODE */
0xfe, /* [441'0x1b9] INVALID */
0x21, /* [442'0x1ba] INVALID' byte */
0x55, /* [443'0x1bb] SSTORE */
0xe6, /* [444'0x1bc] INVALID' byte */
0x6c, /* [445'0x1bd] PUSH13 */
0x2f,0x56,0xc3,0x86,0x7b,0x5b,0x00,0x29,};

const eevm::Code& eevm::EVM2CPP_incorrect_constructor_name1::bytecode() {
    return _contract_bytecode;
}

const std::string eevm::EVM2CPP_incorrect_constructor_name1::_contract_name = "incorrect_constructor_name1";
[[maybe_unused]] const eevm::DerivedRegister<eevm::EVM2CPP_incorrect_constructor_name1> eevm::EVM2CPP_incorrect_constructor_name1::reg{};
const std::string& eevm::EVM2CPP_incorrect_constructor_name1::name() {
...
constexpr uint256_t c_2e4071d4 = 0x2e4071d4_u256;
...
constexpr uint256_t g_26 = 0x2f56c3867b5b0029_u256;
constexpr uint256_t g_25 = 0x401116c25ce3ba48e77d7f87_u256;
...
// code
void eevm::EVM2CPP_incorrect_constructor_name1::dispatch() {
...
/* EQ */
/* op_0 = Constant((8, 775975380)) */
/* op_1 = InstructionRef((6, 0)) */
const uint256_t v_9_0 = eq_v(c_2e4071d4, v_6_0);
...
throw Exception(ET::illegalInstruction, "invalid instruction @ 0x19b (inst offset 3; byte 0xb8)");
...
{ /* <============ */ 
on_bb_start(421);
throw Exception(ET::illegalInstruction, "invalid instruction @ 0x1a5 (inst offset 0; byte 0xbd)");
...
{ /* <============ */ 
on_bb_start(422);
throw Exception(ET::illegalInstruction, "invalid instruction @ 0x1a6 (inst offset 0; byte 0xab)");
...
{ /* <============ */ 
on_bb_start(423);
throw Exception(ET::illegalInstruction, "invalid instruction @ 0x1a7 (inst offset 0; byte 0x4a)");
...
{ /* <============ */ 
on_bb_start(424);
throw Exception(ET::illegalInstruction, "invalid instruction @ 0x1a8 (inst offset 0; byte 0xb9)");
...
const uint256_t s_0_2 = ctxt->s.peek(2);
/* PUSH12 */
/* val = [19827699844923904819690569607] */

/* LOG2 */
/* op_0 = Constant((0, 19827699844923904819690569607)) */
/* op_1 = StackRef((0, 0)) */
/* op_2 = StackRef((0, 1)) */
/* op_3 = StackRef((0, 2)) */
log2_v(g_25, s_0_0, s_0_1, s_0_2);


throw Exception(ET::illegalInstruction, "invalid instruction @ 0x1a9 (inst offset 2; byte 0x5f)");
...
{ /* <============ */ 
on_bb_start(442);
throw Exception(ET::illegalInstruction, "invalid instruction @ 0x1ba (inst offset 0; byte 0x21)");
...
throw Exception(ET::illegalInstruction, "invalid instruction @ 0x1bb (inst offset 1; byte 0xe6)");
...
on_bb_start(445);
/* PUSH13 */
/* val = [3411128750142324777] */

/* BB finalizer */
/* no stack sets */
/* no pops at end */
/* BB return 0 Constant((0, 3411128750142324777))*/
ctxt->s.push(g_26);
}exit_label:
  return;
}
...
const eevm::Code& eevm::EVM2CPP_incorrect_constructor_name1::constructor_args() {
